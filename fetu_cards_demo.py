...
max_binA, bin_totalA, max_hexA, max_decA, fetu_totalA, fetu_totalsA = fetu_max_entropy(hka_deckA)
max_binB, bin_totalB, max_hexB, max_decB, fetu_totalB, fetu_totalsB = fetu_max_entropy(hka_deckB)
