...
glyphsA, glyph_sumsA, glyph_totalA = get_fetu_glyphs(hka_deckA)
glyphsB, glyph_sumsB, glyph_totalB = get_fetu_glyphs(hka_deckB)
...
print(glyphsA, glyph_sumsA, glyph_totalA)
print(glyphsB, glyph_sumsB, glyph_totalB)
